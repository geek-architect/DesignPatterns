...
public class ConcreteVisitorA implements IVisitor {
    private static final Logger LOG = LoggerFactory.getLogger(ConcreteVisitorA.class);

    @Override
    public void visit(ConcreteVisitableA concreteVisitableA) {
        LOG.info("访问方式：ConcreteVisitorA 被访问者：{}", concreteVisitableA.getVisitableInfo());
    }

    @Override
    public void visit(ConcreteVisitableB concreteVisitableB) {
        LOG.info("访问方式：ConcreteVisitorA 被访问者：{}", concreteVisitableB.getVisitableInfo());
    }
}

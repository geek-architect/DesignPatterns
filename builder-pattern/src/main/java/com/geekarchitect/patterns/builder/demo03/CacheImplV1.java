...
public class CacheImplV1<K, V> implements ICache<K, V> {
    ...
    public CacheImplV1(int initialCapacity, long maximumSize, int concurrencyLevel, long maximumWeight, long expireAfterWriteNanos, long expireAfterAccessNanos) {

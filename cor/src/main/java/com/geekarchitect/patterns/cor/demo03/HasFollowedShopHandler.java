...
@Component
@Scope("prototype")
public class HasFollowedShopHandler extends AbstractVerificationHandler {
    private static final Logger LOG = LoggerFactory.getLogger(HasFollowedShopHandler.class);
